...
export BASE24_THEME="vesper"

color00="10/10/10" # Base 00 - Black
color01="ff/80/80" # Base 08 - Red
color02="99/ff/e4" # Base 0B - Green
color03="ff/c7/99" # Base 0A - Yellow
color04="b0/b0/b0" # Base 0D - Blue
color05="ff/d1/a8" # Base 0E - Magenta
color06="66/dd/cc" # Base 0C - Cyan
color07="ff/ff/ff" # Base 05 - White
color08="5c/5c/5c" # Base 03 - Bright Black
color09="ff/80/80" # Base 12 - Bright Red
color10="99/ff/e4" # Base 14 - Bright Green
color11="ff/c7/99" # Base 13 - Bright Yellow
color12="b0/b0/b0" # Base 16 - Bright Blue
color13="ff/d1/a8" # Base 17 - Bright Magenta
color14="66/dd/cc" # Base 15 - Bright Cyan
color15="ff/ff/ff" # Base 07 - Bright White
color16="ff/c7/99" # Base 09
color17="ff/c7/99" # Base 0F
color18="23/23/23" # Base 01
color19="23/23/23" # Base 02
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Pj 232323 # selection color
