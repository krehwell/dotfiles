...
color06="8f/bc/bb" # Base 0C - Cyan
color07="ec/ef/f4" # Base 05 - White
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Pj 40505d # selection color
