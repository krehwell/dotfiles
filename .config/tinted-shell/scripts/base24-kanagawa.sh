...
color14="7f/b4/ca" # Base 15 - Bright Cyan
color15="dc/d7/ba" # Base 07 - Bright White
color16="ff/a0/66" # Base 09
color17="ff/a0/66" # Base 0F
color18="2a/2a/37" # Base 01
color19="32/38/4b" # Base 02
color20="c8/c3/aa" # Base 04
color21="dc/d7/ba" # Base 06
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Pj 32384b # selection color
